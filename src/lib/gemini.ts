...
- character_prompt: Eine detaillierte englische Bildbeschreibung für einen zentrierten, sympathischen Chibi-Charakter im Chibi/Anime-Illustrationsstil mit passender Mimik/Geste zum Thema. WICHTIG: Die Bildbeschreibung MUSS zwingend fordern, dass der Hintergrund eine vollkommen einheitliche, flache Farbe exakt passend zur "Oberer Hintergrund"-Farbe der gewählten Kategorie hat (z. B. "on a completely solid, flat pale pastel mint #F0FDF4 background without gradients or shadows" bei 'Meine Suche', "on a completely solid, flat pale pastel sky blue #F0F9FF background" bei 'Über mich', "on a completely solid, flat gentle powder rose #FFF1F5 background" bei 'Liebe & Beziehung'), damit der Übergang zur oberen Kartenhälfte vollkommen nahtlos und unsichtbar ist.
